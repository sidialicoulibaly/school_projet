...
import { role, parentsData } from "@/lib/data"; // Assurez-vous d'utiliser le bon tableau, ici `parentsData`
...
type Parent = {
  ...
  name: string;
  email?: string;
  students: string[]; // La liste des noms des étudiants associés
  phone: string;
  address: string;
};
  ...
  const renderRow = (item: Parent) => (
    ...
    >
      ...
      <td className="hidden md:table-cell">
        {item.students ? item.students.join(", ") : "N/A"}
      </td>
